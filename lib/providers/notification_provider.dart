...
class NotificationProvider with ChangeNotifier {
  ...
  Future<void> _loadUnreadCount() async {
    try {
      ...
      _logger.fine('hasCachedData: $hasCachedData, isCacheStale: $isCacheStale');
      ...
      if (hasCachedData && !isCacheStale) {
        ...
        if (_currentUserId != null) {
          _logger.info('UserId exists: $_currentUserId - fetching from database');
  ...
  void _listenToNotifications() {
    ...
    _notificationSubscription = _supabase
        ...
        .listen((data) {
          ...
          _logger.fine('Cached ${notificationModels.length} notification objects from stream');
          ...
          if (_unreadCount != newUnreadCount) {
            ...
            _logger.info('Stream updated unread count: $_unreadCount (stream takes precedence)');
            notifyListeners();
