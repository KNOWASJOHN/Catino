...
/// Utility class for caching user session data to minimize Firebase Auth calls
class UserSessionCache {
  ...
  /// Get current user ID with caching to minimize Firebase Auth calls
  Future<String?> getCurrentUserId({bool forceRefresh = false}) async {
    try {
      ...
      // Get fresh UID from Firebase Auth
